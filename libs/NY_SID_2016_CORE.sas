...
*  Data Step                  *;                                                
*******************************;                                                
DATA NY_SIDC_2016_CORE;                                                         
INFILE 'NY_SID_2016_CORE.ASC' FIRSTOBS=3 LRECL = 837;                           
...
INPUT                                                                           
      ...
      @125    HCUP_OS                       N2PF.                               
      @127    HISPANIC                      N2PF.                               
      @129    HISPANIC_X                    $CHAR1.                             
      @130    Homeless                      N2PF.                               
      @132    HOSPST                        $CHAR2.                             
      @134    I10_DX_Admitting              $CHAR7.                             
      @141    I10_DX1                       $CHAR7.                             
      @148    I10_DX2                       $CHAR7.                             
      @155    I10_DX3                       $CHAR7.                             
      @162    I10_DX4                       $CHAR7.                             
      ...
      @302    I10_DX24                      $CHAR7.                             
      @309    I10_DX25                      $CHAR7.                             
      @316    I10_ECAUSE1                   $CHAR7.                             
      @323    I10_ECAUSE2                   $CHAR7.                             
      @330    I10_ECAUSE3                   $CHAR7.                             
      @337    I10_ECAUSE4                   $CHAR7.                             
      @344    I10_ECAUSE5                   $CHAR7.                             
      @351    I10_ECAUSE6                   $CHAR7.                             
      @358    I10_ECAUSE7                   $CHAR7.                             
      @365    I10_ECAUSE8                   $CHAR7.                             
      @372    I10_ECAUSE9                   $CHAR7.                             
      @379    I10_NDX                       N3PF.                               
      @382    I10_NECAUSE                   N2PF.                               
      @384    I10_NPR                       N3PF.                               
      @387    I10_PR1                       $CHAR7.                             
      @394    I10_PR2                       $CHAR7.                             
      @401    I10_PR3                       $CHAR7.                             
      ...
      @578    PL_UIC                        N2PF.                               
      @580    PL_UR_CAT4                    N2PF.                               
      @582    POA_Disch_Edit1               N2PF.                               
      @584    POA_Disch_Edit2               N2PF.                               
      @586    POA_Hosp_Edit1                N2PF.                               
      @588    POA_Hosp_Edit2                N2PF.                               
      @590    POA_Hosp_Edit3                N2PF.                               
      @592    POA_Hosp_Edit3_Value          N8P2F.                              
      @600    PointOfOrigin_X               $CHAR1.                             
      @601    PointOfOriginUB04             $CHAR1.                             
      @602    PRDAY1                        N5PF.                               
      @607    PRDAY2                        N5PF.                               
      @612    PRDAY3                        N5PF.                               
      @617    PRDAY4                        N5PF.                               

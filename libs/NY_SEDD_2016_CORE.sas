...
*  Data Step                  *;                                                
*******************************;                                                
DATA NY_SEDDC_2016_CORE;                                                        
INFILE 'NY_SEDD_2016_CORE.ASC' FIRSTOBS=3 LRECL = 1266;                         
...
INPUT                                                                           
      ...
      @827    HCUP_OS                       N2PF.                               
      @829    HISPANIC                      N2PF.                               
      @831    HISPANIC_X                    $CHAR1.                             
      @832    Homeless                      N2PF.                               
      @834    HOSPST                        $CHAR2.                             
      @836    I10_DX_Visit_Reason1          $CHAR7.                             
      @843    I10_DX1                       $CHAR7.                             
      @850    I10_DX2                       $CHAR7.                             
      @857    I10_DX3                       $CHAR7.                             
      @864    I10_DX4                       $CHAR7.                             
      ...
      @1004   I10_DX24                      $CHAR7.                             
      @1011   I10_DX25                      $CHAR7.                             
      @1018   I10_ECAUSE1                   $CHAR7.                             
      @1025   I10_ECAUSE2                   $CHAR7.                             
      @1032   I10_ECAUSE3                   $CHAR7.                             
      @1039   I10_ECAUSE4                   $CHAR7.                             
      @1046   I10_ECAUSE5                   $CHAR7.                             
      @1053   I10_ECAUSE6                   $CHAR7.                             
      @1060   I10_ECAUSE7                   $CHAR7.                             
      @1067   I10_ECAUSE8                   $CHAR7.                             
      @1074   I10_ECAUSE9                   $CHAR7.                             
      @1081   I10_NDX                       N3PF.                               
      @1084   I10_NECAUSE                   N2PF.                               
      @1086   I10_PROCTYPE                  N3PF.                               
      @1089   KEY                           15.                                 
      @1104   LOS                           N5PF.                               
      @1109   LOS_X                         N6PF.                               
      @1115   MDNUM1_R                      N9PF.                               
      ...
      @1206   STATE_OS                      N2PF.                               
      @1208   TOTCHG                        N10PF.                              
      @1218   TOTCHG_X                      N15P2F.                             
      @1233   VisitLink                     N9PF.                               
      @1242   YEAR                          N4PF.                               
      @1246   ZIP                           $CHAR5.                             
      @1251   ZIP3                          $CHAR3.                             
      @1254   ZIPINC_QRTL                   N3PF.                               
      @1257   AYEAR                         N4PF.                               
      @1261   BMONTH                        N2PF.                               
      @1263   BYEAR                         N4PF.                               
      ;                                                                         
